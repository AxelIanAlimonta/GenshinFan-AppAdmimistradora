...
export default function EditarVideo() {
    ...
    const handleEliminarEtiqueta = (etiqueta: TipoEtiqueta) => {
        ...
        setEtiquetasSinAsignar((prev) => [...prev, etiqueta]);
    };
    ...
    return (
        ...
        <Form className="editarVideo-formulario" onSubmit={handleSubmit}>
            <Tabs defaultActiveKey="videoInfo" id="editarVideo-tabs" className="editarVideo-tabs">
                <Tab eventKey="videoInfo" title="Información del Video" className="editarVideo-videoInfo-tab">
                    <div className="editarVideo-videoInfo">
                ...
                <Tab eventKey="etiquetas" title="Etiquetas">
                    <section className="editarVideo-etiquetas">
                        <Tabs
                            ...
                            className="editarVideo-etiquetas-tabs"
                        >
                            <Tab eventKey="etiquetas" title="Etiquetas asignadas" className="editarVideo-etiquetas-tab">
                                <Form.Group className="mb-3 editarVideo-etiquetas-formGroup">
                                    <Form.Label className="editarVideo-label">
                                    ...
                                    {etiquetasAsignadasFiltradas.length === 0 && (
                                        <p className="editarVideo-sinEtiquetas">No hay etiquetas asignadas</p>
                                    )}
                            ...
                            <Tab eventKey="eliminar" title="Eliminar Etiquetas" className="editarVideo-eliminar-tab">
                                <Form.Group className="mb-3 editarVideo-etiquetas-formGroup">
